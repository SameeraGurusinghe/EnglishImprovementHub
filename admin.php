...
<!--HEADER END HERE-->
    ...
    <h1 style="font-size:50px"><b>Dashboard</b></h1>
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-info">
              <div class="inner">
                ...
                <p style="text-align:center; font-size:50px;">Profile</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-success">
              <div class="inner">
                ...
                <p style="text-align:center; font-size:50px;">Add New Admin</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-warning">
              <div class="inner">
                ...
                <p style="text-align:center; font-size:50px;">Add new Challange</p>
              </div>
              <div class="icon">
          ...
          <div class="col-lg-3 col-6">
            ...
            <div class="small-box bg-danger">
              <div class="inner">
                ...
                <p style="text-align:center; font-size:50px;">Contact</p>
              </div>
              <div class="icon">
